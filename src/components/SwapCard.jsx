...
function SwapCard() {
    return (
        <div className="bg-[#1F1F1F] w-1/3 rounded-2xl h-[50vh] p-2  my-6 sm:w-[70%] md:w-3/5 md:my-4 md:h-3/5 lg:w-2/5 xl:w-1/3 xl:h-[55%] xl:my-6 min-[320px]:w-[90%]">
            <div className="relative flex flex-col gap-y-1 h-[83%] md:h-[82%]">
                <div className="border border-zinc-600 h-1/2 rounded-2xl py-3 px-4 flex justify-between items-center">
                    ...
                    <div className="right w-1/4 min-[320px]:w-1/2 sm:w-1/3 sm:h-auto md:w-[35%] lg:w-[130px] min-[2000px]:w-[15%]">
                        <div className="border border-[#ffffffa6] cursor-pointer w-full flex rounded-full justify-center items-center gap-1 px-4 py-1 sm:py-0 sm:px-0 md:p-0 xl:py-1 xl:px-4">
                            <img src={ETH} alt="ETH token" className=" w-1/2 pl-1  sm:object-contain sm:py-1 sm:w-[35%] lg:w-[35%] xl:w-1/2 xl:h-full " />
                ...
                <div className="bg-[#161615] h-1/2 rounded-2xl py-3 px-4 flex justify-between items-center">
                    ...
                    <div className="right flex flex-col justify-end items-end w-2/3 min-[320px]:w-[170%] sm:w-[40%] md:w-3/5 xl:w-2/3">
                        <button className="bg-[#508dc7] py-1 font-bold tracking-wide px-4 rounded-full flex items-center justify-center gap-2 text-lg min-[320px]:text-xs min-[320px]:py-[7px] sm:text-sm md:text-[1rem] 2xl:text-lg xl:py-1">
                            Select token
                            <IoIosArrowDown className="min-[320px]:hidden" />
                        </button>
                    </div>
                </div>
            </div>
